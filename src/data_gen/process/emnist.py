...
def process(output_dir="./datasets/raw"):
    ...
    train_set = datasets.EMNIST(root=output_dir, split="balanced", train=True, download=True)
    test_set = datasets.EMNIST(root=output_dir, split="balanced", train=False, download=True)
